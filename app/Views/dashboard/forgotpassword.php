                ...
                <div class="row">
                    <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
                        <div class="card card-primary">
                            ...
                            <?php endif; ?>
                            <div class="card-body">
                                <form method="post" action="<?= base_url('/forgotPassword/resetlink'); ?>">
                                    <?= csrf_field(); ?>
                                    <span class="text-muted">Kami akan mengirimkan anda email untuk mengganti password.</span>
                                    <div class="form-group">
                                        <label for="email">Email</label>
                                        <input id="email" type="email" class="form-control <?= ($validation->hasError('email')) ?
                                                                                                'is-invalid' : ''; ?>" name="email" tabindex="1" required autofocus>
